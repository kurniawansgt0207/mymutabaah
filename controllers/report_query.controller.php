<?php
    ...
    class report_queryController extends report_queryControllerGenerate
    {
        ...
        function showHeader(){
            ...
            $yayasan_list_ = $master_yayasanCtrl->showDataAllByCabang($user_list->getUnitid());
            
            $master_kelas = new master_department();
            $master_kelasCtrl = new master_departmentController($master_kelas, $this->dbh);
            $kelas_list_ = $master_kelasCtrl->showDataAll();
            
            $master_kelompok = new master_shaff();
            $master_kelompokCtrl = new master_shaffController($master_kelompok, $this->dbh);
            //$kelompok_list_ = $master_kelompokCtrl->showDataAll();
            $kelompok_list_ = $master_kelompokCtrl->showKelompokByCabangByRanting($user_list->getUnitid(), $user_list->getDepartmentid());
