<?php
    ...
    require_once './controllers/aktifitas_harian.controller.php';
    require_once './models/aktifitas_harian_detail.class.php';
    require_once './controllers/aktifitas_harian_detail.controller.php';
    ...
    class mutabaah_yaumiyahController extends aktifitas_harianController
    {
        function showFormJQuery() {
            ...
            $aktifitas_harian_ = $this->showDataByDate($tgl,$user_list->getId());
            ...
            require_once './views/mutabaah_yaumiyah/mutabaah_yaumiyah_jquery_form.php';            
        }
        
        function saveFormJQuery() {
            $id = isset($_REQUEST['id'])?$_REQUEST['id'] : "";
	    $tgl_aktifitas = isset($_REQUEST['tgl_aktifitas'])?$_REQUEST['tgl_aktifitas'] : "";
	    ...
	    $ip_address = isset($_REQUEST['ip_address'])?$_REQUEST['ip_address'] : $this->ip;
            ...
            $aktifitas = new aktifitas_harian();
            $aktifitasCtrl = new aktifitas_harianController($aktifitas, $this->dbh);
            
	    $aktifitas->setId($id);
	    $aktifitas->setTgl_aktifitas($tgl_aktifitas);
	    ...
	    $aktifitas->setIp_address($ip_address);   
            ...
            if($idHeader > 0){
                ...
                $aktifitas_detail = new aktifitas_harian_detail();
                $aktifitas_detailCtrl = new aktifitas_harian_detailController($aktifitas_detail, $this->dbh);
            ...
            echo "Mutabaah Harian Untuk Tanggal ".$tgl_aktifitas."\nBerhasil Tersimpan.";
        }
    }
?>
